...
async function startSessionTask(){
	...
	const region = await prompt(`Choose your region (default: ${defaultRegion}): `) || defaultRegion
	AWS.config.update({region: region});

	//select profile
	const profile = await prompt(`Choose your profile (default: ${defaultProfile}): `) || defaultProfile
	if (profile !== "default"){
	...
	const instance = await prompt(`Choose instance (default: ${defaultInstance}): `) || defaultInstance
	if (!instance){
...
module.exports = exports = startSessionTask